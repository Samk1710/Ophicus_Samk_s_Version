  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-12">
        ...
        {/* Hero Section */}
        <div className="text-center mb-16 max-w-4xl flex flex-col items-center justify-center min-h-[calc(100vh-12rem)]">
          {/* Title */}
          <div
        ...
        {/* Features Grid */}
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full mt-16 transition-all duration-2000 delay-3000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
