  ...
  return (
    <div className="min-h-[100dvh] relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-20">
        <Globe className="w-60 h-60 sm:w-72 sm:h-72 md:w-96 md:h-96 text-blue-400 animate-spin" style={{ animationDuration: "60s" }} />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 py-10 md:py-16">
        ...
        <div className="absolute top-28 right-5 sm:top-32 sm:right-32 floating-animation opacity-60" style={{ animationDelay: "1s" }}>
          <CelestialIcon type="planet" className="text-purple-400" />
        </div>
        <div className="absolute bottom-32 left-5 sm:bottom-40 sm:left-40 floating-animation opacity-60" style={{ animationDelay: "2s" }}>
          <CelestialIcon type="mystical" className="text-blue-400" />
        </div>
        <div className="absolute bottom-10 right-5 sm:bottom-20 sm:right-20 floating-animation opacity-60" style={{ animationDelay: "0.5s" }}>
        ...
        <div className="text-center mb-12 max-w-5xl w-full flex flex-col items-center justify-center min-h-[calc(100dvh-10rem)] px-4">
          {/* Title */}
          <div className={`mb-8 transition-all duration-2000 ${showTitle ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          {/* Subtitle */}
          <div className={`mb-12 transition-all duration-2000 delay-1000 ${showSubtitle ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          {/* CTA Buttons */}
          <div className={`flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center transition-all duration-2000 delay-2000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <Link href="/login">
        ...
        {/* Features Grid */}
        <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl w-full mt-8 sm:mt-16 transition-all duration-2000 delay-3000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          {[
            {
            ...
            },
            {
              ...
              desc: "Join thousands of cosmic travelers discovering their musical destiny across the galaxy",
            ...
            >
              <div className="mb-6">
                ...
                <CelestialIcon type={feature.celestial as any} className="mx-auto text-purple-400" />
              </div>
              <h3 className="font-cinzel text-lg sm:text-xl font-bold text-gold-100 mb-3">{feature.title}</h3>
              <p className="font-poppins text-sm sm:text-base text-purple-200">{feature.desc}</p>
            </Card>
          ))}
        </div>

        {/* Stats Section */}
        <div className={`mt-12 sm:mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 max-w-4xl w-full transition-all duration-2000 delay-4000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          {[
            ...
            <div key={index} className="text-center">
              ...
              <div className="font-cinzel text-xl sm:text-3xl font-bold text-gold-100 glow-text mb-1">{stat.number}</div>
              <div className="font-poppins text-xs sm:text-sm text-purple-300">{stat.label}</div>
            </div>
          ))}
        </div>

        {/* Mystical Quote */}
        <div className={`mt-12 sm:mt-16 text-center max-w-2xl px-4 transition-all duration-2000 delay-5000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
