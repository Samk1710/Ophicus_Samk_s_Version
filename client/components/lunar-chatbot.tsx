    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-900/40 via-purple-800/40 to-blue-900/40 border-2 border-indigo-400/50 hover:border-indigo-300/70 transition-all duration-300 pulse-glow group relative overflow-hidden"
        >
          {/* Moonlight effect */}
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        {!isMinimized && (
          <>
            {/* Messages */}
            <div className="flex-1 p-4 overflow-y-auto max-h-64 space-y-3 relative z-10">
